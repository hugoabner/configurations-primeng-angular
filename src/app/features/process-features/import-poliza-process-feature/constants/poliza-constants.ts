...
export const COLUMNS_STORAGE_TABLE: Column[] = [
  ...
  { field: 'ASEGURADO', header: 'Nombre Completo' },
  { field: 'CONTRATANTE', header: 'Contratante' },
  { field: 'ENDOSATARIO', header: 'Endosatario' },
  { field: 'TELEFONO', header: 'Teléfono' },
  { field: 'CORREO', header: 'Correo Electrónico' },
  { field: 'NRO POLIZA', header: 'Número de Póliza' },
  { field: 'ESTADO RENOVACION', header: 'Estado de Renovación' },
  { field: 'ESTADO EMISION', header: 'Estado de Emisión' },
  { field: 'SUB ESTADO', header: 'Sub Estado' },
  { field: 'NRO RENOVACION', header: 'Número de Renovación' },
  { field: 'NRO VEHICULO', header: 'Número de Vehículo' },
  { field: 'USUARIO', header: 'Usuario' },
  { field: 'FECHA INICIO DE VIG', header: 'Fecha de Inicio de Vigencia' },
  { field: 'FECHA FIN DE VIG', header: 'Fecha de Fin de Vigencia' },
  { field: 'CIA SEGUROS', header: 'Compañía de Seguros' },
  { field: 'PRODUCTO', header: 'Producto' },
  { field: 'GPS OBLIGATORIO', header: 'GPS Obligatorio' },
  { field: 'COBERTURA', header: 'Cobertura' },
  { field: 'USO', header: 'Uso' },
  { field: 'CLASE', header: 'Clase' },
  { field: 'TIENE GPS', header: 'Tiene GPS' },
  { field: 'MARCA', header: 'Marca' },
  { field: 'MODELO', header: 'Modelo' },
  { field: 'ANIO', header: 'Año' },
  { field: 'PLACA', header: 'Placa' },
  { field: 'TIMON', header: 'Timón' },
  { field: 'COLOR', header: 'Color' },
  { field: 'NRO MOTOR', header: 'Número de Motor' },
  { field: 'NRO CHASIS', header: 'Número de Chasis' },
  { field: 'SUM ASEG', header: 'Suma Asegurada' },
